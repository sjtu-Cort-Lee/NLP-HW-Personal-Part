#!/usr/bin/env python
"""Run token-by-token perplexity evaluation."""
...
from kv_cache_compression.eval import evaluate_perplexity, result_to_dict
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--dataset", choices=["wikitext", "pg19", "text"], default="wikitext")
    ...
    parser.add_argument("--output", default="results/raw/ppl.json")
...
def main() -> None:
    ...
    print(f"Wrote {len(records)} PPL records to {args.output}")
